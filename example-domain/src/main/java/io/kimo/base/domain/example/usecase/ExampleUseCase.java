 ...
 * Example use case
 *
 * This use case is supposed to return an array of ExampleEntities.
 *
 ...
 * In this scenario the use case returns an array of ExampleEntity.
...
public class ExampleUseCase extends BaseUseCase<List<ExampleEntity>> {
    ...
    @Override
    public List<ExampleEntity> perform() throws Exception {
